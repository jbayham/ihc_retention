...
dataPRD3 <- readRDS(file = "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\cache\\dataPRD_wSURV.rds")
...
write.csv(dataPRD4, file = "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\cache\\dataPRD_wIncomeBin.csv")
