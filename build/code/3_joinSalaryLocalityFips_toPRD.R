...
################################################################################
library(dplyr)
dataPRD <- readRDS(file = "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\cache\\PRD_IHC.rds")

# Contains salary data by crew by year (res_id_primary and year are the joining columns)
filepathSalary <- "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\inputs\\IHC_salary_estimates.csv"

# Contains fips codes (code) and area name (area1) PER year (year)
fileFIPSandCode <- "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\inputs\\FIPScodeandNames.txt"

# Contains fips and crew level res_id
filepathFIPS <- "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\inputs\\IHC_home_base_locations_wFIPS.txt"
...
LocPayALL <- readRDS("C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\cache\\LocPayALL.rds")
...
saveRDS(dataPRD, file = "C:\\Users\\magst\\Desktop\\git\\ihc_retention\\build\\cache\\dataPRD_join.rds")
